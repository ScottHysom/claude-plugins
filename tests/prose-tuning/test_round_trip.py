...
class DescribeInsertThenStrip:
    def it_strips_an_inline_deletion(self, round_trip):
        round_trip(
            [
                {
                    "file": "sample.md",
                    ...
                    "col_start": 0,
                    "col_end": 38,
                    "why": "restates the passage",
                },
            ]
        )

    def it_strips_a_block_deletion(self, round_trip):
    ...
    def it_strips_a_block_deletion_with_a_blank_line_at_an_edge(self, round_trip, start, end):
    ...
    def it_strips_an_inline_replacement(self, round_trip):
