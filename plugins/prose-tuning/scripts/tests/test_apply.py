...
class TestGuards:
    ...
    def test_a_rule_the_config_does_not_define_is_refused(self, prose_repo, target_lines):
        code, envelope = prose_repo.apply(
            [
    ...
    def test_text_that_moved_since_the_report_is_refused(self, prose_repo, target_lines):
    ...
    def test_columns_outside_the_line_are_refused(self, prose_repo, target_lines, cols):
    ...
    def test_two_edits_on_the_same_span_are_refused(self, prose_repo, target_lines):
...
class TestPartial:
    ...
    def test_by_default_one_bad_finding_writes_nothing(self, prose_repo, target_lines):
        before = prose_repo.read()
    ...
    def test_partial_still_leaves_the_protected_line_alone(self, prose_repo, target_lines):
