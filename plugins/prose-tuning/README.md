...
plugin. That folder has to be in the project's `.gitignore`, or `commit.sh`
commits it. Projects made by `cowork-project-scaffold` 0.5.2 or
`gitify-cowork-project` 0.2.1 and later already list it. For an older
project, the skill refuses to start until the line is there, and offers to add
it.
