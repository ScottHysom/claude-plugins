...
- `device_commit_files` creates any directory it is missing, so a mistyped
  folder would quietly become a new, empty one. That is why probe and the
  precheck both refuse a folder that is not there.
